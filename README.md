...
You can build by running : `docker build -t justin2997/notifications-microservice .`
You can run with : `docker run -p:8080:8080 -d justin2997/notifications-microservice:latest`
